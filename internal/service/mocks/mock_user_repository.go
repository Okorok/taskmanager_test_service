...
func (_m *MockUserRepository) Create(ctx context.Context, request repository.CreateUserRequest) (*entity.User, error) {
	...
	var r0 *entity.User
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, repository.CreateUserRequest) (*entity.User, error)); ok {
		return rf(ctx, request)
	}
	if rf, ok := ret.Get(0).(func(context.Context, repository.CreateUserRequest) *entity.User); ok {
		r0 = rf(ctx, request)
	} else {
		if ret.Get(0) != nil {
...
//   - ctx context.Context
//   - request repository.CreateUserRequest
func (_e *MockUserRepository_Expecter) Create(ctx interface{}, request interface{}) *MockUserRepository_Create_Call {
	return &MockUserRepository_Create_Call{Call: _e.mock.On("Create", ctx, request)}
}

func (_c *MockUserRepository_Create_Call) Run(run func(ctx context.Context, request repository.CreateUserRequest)) *MockUserRepository_Create_Call {
...
func (_c *MockUserRepository_Create_Call) RunAndReturn(run func(context.Context, repository.CreateUserRequest) (*entity.User, error)) *MockUserRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockUserRepository) GetByID(ctx context.Context, id int64) (*entity.User, error) {
...
func (_c *MockUserRepository_GetByID_Call) RunAndReturn(run func(context.Context, int64) (*entity.User, error)) *MockUserRepository_GetByID_Call {
	_c.Call.Return(run)
	return _c
}
